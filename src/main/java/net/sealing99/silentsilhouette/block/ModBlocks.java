package net.sealing99.silentsilhouette.block;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(TheSilentSilhouette.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(
            Registries.ITEM, Identifier.of(TheSilentSilhouette.MOD_ID, name),
            new BlockItem(block, new Item.Settings())
        );
    }

    public static void registerModBlocks() {
        TheSilentSilhouette.LOGGER.info("Registering ModBlocks for " + TheSilentSilhouette.MOD_ID);
